...
public class TablistToggleCommand extends CommandBase {
    @Override
    public String getCommandName() { return "tabstats"; }

    @Override
    public String getCommandUsage(ICommandSender sender) { return "/tabstats <on/off>"; }
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        ModConfig.getInstance().tabstats = enable;
